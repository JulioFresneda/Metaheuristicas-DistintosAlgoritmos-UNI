...
namespace MHP2
{
    class AM : AG
    {
        public AM(string ruta, bool _pmx = false, int _ciclosMeme = 10, float _porcentajeMeme = 1, bool _mejorPorcentajeMeme = false,  int num_Cromosomas = 50, float prob_Cruce = 0.7F, float prob_Mutacion = 0.001F, int num_Iteraciones = 50000)
        {
